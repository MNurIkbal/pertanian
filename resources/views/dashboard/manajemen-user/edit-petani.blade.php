...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="card-body">
                    <h4>Edit Akun Petani</h4>
                    <form action="{{ route('manajemen-user.update', ['id' => encrypt($user->id)]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($user->photo_profile != null)
                                <img src="{{ asset($user->photo_profile) }}" alt=""  class="img-preview img-fluid mb-3 col-sm-5 d-block">
                            @endif
